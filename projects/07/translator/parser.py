...
Responsible for parsing a single VM file and encapsulating access to the input
...
class Parser:
    ...
    Encapsulates access to the input code. Reads a VM program and provides
    access to its components.

    Attributes:
      - file (TextIO): The input VM file that has been opened with read
      permissions.
    """
    ...
    def has_more_commands(self) -> bool:
        ...
        Returns:
          A Boolean representing whether there are more commands in the input
          file.
        """
        pos = self._file.tell()
    ...
    def advance(self) -> None:
        ...
        Only works when `has_more_commands` is true.
        """
